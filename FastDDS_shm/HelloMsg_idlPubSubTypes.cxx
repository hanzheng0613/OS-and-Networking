...
/*!
 * @file HelloMsg_idlPubSubTypes.cpp
...
#include "HelloMsg_idlCdrAux.hpp"
...
HelloMsgPubSubType::HelloMsgPubSubType()
{
    ...
    uint32_t key_length = HelloMsg_max_key_cdr_typesize > 16 ? HelloMsg_max_key_cdr_typesize : 16;
...
{
    const ::HelloMsg* p_type = static_cast<const ::HelloMsg*>(data);
...
uint32_t HelloMsgPubSubType::calculate_serialized_size(
        const void* const data,
        DataRepresentationId_t data_representation)
{
    try
    {
        ...
        return static_cast<uint32_t>(calculator.calculate_serialized_size(
                    *static_cast<const ::HelloMsg*>(data), current_alignment)) +
                4u /*encapsulation*/;
    }
    catch (eprosima::fastcdr::exception::Exception& /*exception*/)
    {
...
void* HelloMsgPubSubType::create_data()
{
    return reinterpret_cast<void*>(new ::HelloMsg());
}

void HelloMsgPubSubType::delete_data(
        void* data)
{
    delete(reinterpret_cast<::HelloMsg*>(data));
}

bool HelloMsgPubSubType::compute_key(
        SerializedPayload_t& payload,
...
#include "HelloMsg_idlCdrAux.ipp"
